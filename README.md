...
- Sentinel scaffolds `.sentinel/docs/IMPLEMENTATION.md` as a living report (Current Enforcement Surface, Execution Flow, Known Gaps, CI Workflow, Stack Context).
- `/speckit.plan` (or CapsuleAuthor) can append stack/architecture notes via the upcoming Python CLI; keep it committed so newcomers see how the system fits together.
