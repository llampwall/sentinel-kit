...
3. Follow Given/When/Then comments and reference the decision ID that introduced the fix (from .sentinel/DECISIONS.md). Stamp the ProducedBy= header emitted by the decision-log CLI onto each changed file.
